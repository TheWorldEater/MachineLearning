...
namespace gl_texture {
	...
	public:
		...
		void upload_mipmap (int mip, pixel_format_e format, void* pixels, s32v2 size_px) {
	...
	public:
		...
		// single mip
		void upload (pixel_format_e format, void* pixels, s32v2 size_px) {
	...
	Texture2D single_mip_texture (pixel_format_e format, void* pixels, s32v2 size_px, minmag_filter_e minmag=FILTER_BILINEAR, aniso_filter_e aniso=FILTER_ANISO, border_e border=BORDER_CLAMP, rgba8 border_color=0) {
