...
namespace imgl {
	...
	void draw_solid (Solid_Vertex const* vertex_data, uptr vertex_count) {
		...
		static auto shad = load_shader("../imgl/shaders/solid.vert", "../imgl/shaders/solid.frag");
	...
	void push_rect (std::vector<Textured_Vertex>* vbo_data, fv2 pos_l, fv2 pos_h, fv2 uv_l, fv2 uv_h, rgba8 col=255) {
		for (fv2 p : { fv2(1,0), fv2(1,1), fv2(0,0), fv2(0,0), fv2(1,1), fv2(0,1) } )
	...
	void draw_textured (Textured_Vertex const* vertex_data, uptr vertex_count, Texture2D const& tex) {
		...
		static auto shad = load_shader("../imgl/shaders/textured.vert", "../imgl/shaders/textured.frag");
